...
#define MFM384C_CONFIG_BAUDRATE		9600
#define MFM384C_CONFIG_DATA_BITS	8
#define MFM384C_CONFIG_PARITY_BITS	'N'
#define MFM384C_CONFIG_STOP_BITS	1
#define MFM384C_CONFIG_PORT			"/dev/ttyUSB0"
#define MFM384C_CONFIG_SLAVE_ID		1
#define MFM384C_CONFIG_RESPONSE_TIMEOUT_S	1		//Default is 0
#define MFM384C_CONFIG_RESPONSE_TIMEOUT_US	0		//Default is 500000
#define MFM384C_CONFIG_BYTE_TIMEOUT_S		1		//Default is 0
#define MFM384C_CONFIG_BYTE_TIMEOUT_US		0		//Default is 500000
...
//struct timeval response_timeout = {MFM384C_CONFIG_RESPONSE_TIMEOUT_S,MFM384C_CONFIG_RESPONSE_TIMEOUT_US};
//struct timeval byte_timeout = {MFM384C_CONFIG_BYTE_TIMEOUT_S,MFM384C_CONFIG_BYTE_TIMEOUT_US};
...
int main(int argc, char **argv) {
	...
	ctx = modbus_new_rtu(MFM384C_CONFIG_PORT, MFM384C_CONFIG_BAUDRATE, MFM384C_CONFIG_PARITY_BITS, MFM384C_CONFIG_DATA_BITS, MFM384C_CONFIG_STOP_BITS);// Creates new Modbus RTU connection
	...
	if (modbus_connect(ctx) == -1) {
		...
		modbus_set_byte_timeout(ctx, MFM384C_CONFIG_BYTE_TIMEOUT_S,MFM384C_CONFIG_BYTE_TIMEOUT_US);
		modbus_set_response_timeout(ctx, MFM384C_CONFIG_RESPONSE_TIMEOUT_S,MFM384C_CONFIG_RESPONSE_TIMEOUT_US);
